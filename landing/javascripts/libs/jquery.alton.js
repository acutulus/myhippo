  ...
  $.fn.alton = function(options) {
    ...
    $.fn.scrollTo = function(element) {
      ...
      , onUpdate: function(){
          ...
          $(element).css("transform", scaleProportion(0, windowHeight, 1, 0, elementOffset));
          //console.log($(element).css("opacity"));
        }

        */
        TweenLite.to(window, 0.9, {scrollTo:{y:$(element).offset().top}, ease: Power3.easeInOut,
        onUpdate: function(){
          scrolledPage = $(element).offset().top;
        }});
      } else {
        /*$("body,html").stop(true, true).animate({
        ...
        TweenLite.to(window, 0.9, {scrollTo:{y:$(document).outerHeight() - windowHeight}, ease: Power3.easeInOut});
      }
    };
